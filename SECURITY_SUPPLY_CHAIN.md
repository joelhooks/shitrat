...
This repo treats dependency, workflow, source, extension, and release changes as security-sensitive.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, TypeScript/JavaScript source, extensions, and release config.
